function Imetakip () {
    return(
        ...
        <div class="container-fluid pt-4 px-4">
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-light rounded h-100 p-4">
                            <h6 class="mb-4">İME Başvuru Formu Yükleme Alanı</h6>
                                <div class="mb-3">
                ...
                <div class="col-sm-12 col-xl-6">
                    <div class="bg-light rounded h-100 p-4">
                        <p class="mb-4" style={{fontSize:25, color: "#000"}}> Öğrenciler Başvurular kısmından İME başvuru formunu doldurup çıktısını almalıdırlar. </p>
                        <p class="mb-4" style={{fontSize:25, color: "#000"}}>Gerekli belgeleri iş yerine kaşeletip imzalattıktan sonra İME Başvuru Formu Yükleme Alanına yüklemeleri gerekmektedirler.</p>
                    </div>
                </div>
