    ...
    return (
        ...
        <div class="container-fluid pt-4 px-4">
                <div class="row g-4">
                    ...
                    <div class="col-sm-12 col-xl-12">
                        <div class="bg-light rounded h-100 p-4">
                            <h6 class="mb-4">Staj Değerlendirme</h6>
                            <label for="form-label" class="form-label">Staj sınavını tamamladınız. Not takibini bu alandan yapabilirsiniz.</label>
                            <br/>
                            <p style={{fontSize:25, color: "#000"}}>
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="green" class="bi bi-check2-circle" viewBox="0 0 16 16">
                                    <path d="M2.5 8a5.5 5.5 0 0 1 8.25-4.764.5.5 0 0 0 .5-.866A6.5 6.5 0 1 0 14.5 8a.5.5 0 0 0-1 0 5.5 5.5 0 1 1-11 0z"/>
...
export default Stajdegerlendirme;